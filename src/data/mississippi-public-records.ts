...
export const MS_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "ms_doc", name: "Inmate Search", agency: "MS DOC", description: "Current inmates in Mississippi facilities", searchUrl: "https://www.mdoc.ms.gov/inmate-information/inmate-search", icon: "ShieldAlert" },
  ...
  { id: "ms_ucc", name: "UCC Filings", agency: "MS Secretary of State", description: "Uniform Commercial Code financing statements", searchUrl: "https://corp.sos.ms.gov/ucc/portal/c/page/uccSearch/portal.aspx", icon: "FileText" },
];

export const MS_LICENSE_SOURCES: RecordSource[] = [
  { id: "ms_medical", name: "Medical License Verification", agency: "MS State Board of Medical Licensure", description: "Physicians licensed in Mississippi", searchUrl: "https://www.msbml.ms.gov/licensure/license-verification", icon: "Stethoscope" },
  { id: "ms_bar", name: "Attorney Search", agency: "MS Bar", description: "Licensed attorneys in Mississippi", searchUrl: "https://www.msbar.org/lawyer-directory.aspx", icon: "Scale" },
];
...
export const MS_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "DeSoto", label: "DeSoto County", url: "https://www.desotocountyms.gov/tax-assessor-collector" },
  { county: "Rankin", label: "Rankin County", url: "https://www.rankincounty.org/285/Tax-Assessor" },
];
