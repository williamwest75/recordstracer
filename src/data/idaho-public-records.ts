...
export const ID_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "id_voter", name: "Voter Registration", agency: "ID Secretary of State", description: "Voter registration status", searchUrl: "https://elections.sos.idaho.gov/ElectionLink/ElectionLink/ViewVoterRegistration.aspx", icon: "Vote" },
...
export const ID_LICENSE_SOURCES: RecordSource[] = [
  { id: "id_ibol", name: "Professional License Lookup", agency: "ID IBOL", description: "Various professional and occupational licenses", searchUrl: "https://isecure.boi.idaho.gov/IBOLPublic/LPRBrowser.aspx", icon: "Briefcase" },
  { id: "id_bar", name: "Attorney Search", agency: "ID State Bar", description: "Licensed attorneys in Idaho", searchUrl: "https://isb.idaho.gov/licensing/attorney-roster/", icon: "Scale" },
];

export const ID_CAMPAIGN_FINANCE_SOURCES: RecordSource[] = [
  { id: "id_sos_cf", name: "ID Campaign Finance", agency: "ID Secretary of State", description: "Campaign contributions and expenditures", searchUrl: "https://elections.sos.idaho.gov/TED/CampaignFinanceSearch.aspx", icon: "Vote" },
];
...
export const ID_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Bonneville", label: "Bonneville County Assessor", url: "https://www.co.bonneville.id.us/assessor/" },
];
