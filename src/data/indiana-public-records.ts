...
export const IN_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "in_doc", name: "Offender Search", agency: "IN DOC", description: "Current inmates in Indiana state prisons", searchUrl: "https://www.in.gov/idoc/offender-services/offender-locator/", icon: "ShieldAlert" },
  ...
  { id: "in_ucc", name: "UCC Filings", agency: "IN Secretary of State", description: "Uniform Commercial Code financing statements", searchUrl: "https://inbiz.in.gov/UCC/Home/Search", icon: "FileText" },
];
...
export const IN_CAMPAIGN_FINANCE_SOURCES: RecordSource[] = [
  { id: "in_sos_cf", name: "IN Campaign Finance", agency: "IN Secretary of State", description: "Campaign contributions and expenditures", searchUrl: "https://campaignfinance.in.gov/PublicSite/Homepage.aspx", icon: "Vote" },
];
...
export const IN_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Allen", label: "Allen County", url: "https://www.allencounty.us/assessor" },
  { county: "Hamilton", label: "Hamilton County", url: "https://www.hamiltoncounty.in.gov/211/Assessors-Office" },
  { county: "St. Joseph", label: "St. Joseph County", url: "https://www.stjosephcountyindiana.com/assessor" },
