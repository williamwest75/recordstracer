...
export const AK_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "ak_doc", name: "Offender Search (PRIOR)", agency: "AK DOC", description: "Current and released offenders", searchUrl: "https://doc.alaska.gov/offender/lookup", icon: "ShieldAlert" },
  ...
  { id: "ak_ucc", name: "UCC Filings", agency: "AK DNR Recorder's Office", description: "Uniform Commercial Code financing statements", searchUrl: "https://dnr.alaska.gov/ssd/recoff/", icon: "FileText" },
];
...
export const AK_LICENSE_SOURCES: RecordSource[] = [
  ...
  { id: "ak_bar", name: "Attorney Search", agency: "AK Bar Association", description: "Licensed attorneys in Alaska", searchUrl: "https://www.alaskabar.org/members/member-directory/", icon: "Scale" },
];
...
export const AK_PROPERTY_SOURCES: CountyPropertySource[] = [
  { county: "Anchorage", label: "Municipality of Anchorage", url: "https://www.anchorageak.gov/finance/tax-assessor/property-tax" },
  { county: "Fairbanks North Star", label: "Fairbanks NSB", url: "https://www.fnsb.gov/244/Assessing" },
  { county: "Matanuska-Susitna", label: "Mat-Su Borough", url: "https://www.matsugov.us/government/departments/assessor" },
  { county: "Kenai Peninsula", label: "Kenai Peninsula Borough", url: "https://www.borough.kenai.ak.us/assessordept" },
];
