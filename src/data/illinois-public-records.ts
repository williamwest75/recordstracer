...
export const IL_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "il_doc", name: "Inmate Search", agency: "IL DOC", description: "Current inmates in Illinois state prisons", searchUrl: "https://idoc.illinois.gov/offender/inmateSearch", icon: "ShieldAlert" },
  ...
  { id: "il_ucc", name: "UCC Filings", agency: "IL Secretary of State", description: "Uniform Commercial Code financing statements", searchUrl: "https://www.ilsos.gov/departments/business_services/ucc.html", icon: "FileText" },
];
...
export const IL_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "DuPage", label: "DuPage County", url: "https://www.dupagecounty.gov/services/property/property_info/" },
  ...
  { county: "Winnebago", label: "Winnebago County", url: "https://www.wincoil.us/departments/supervisor-of-assessments" },
  { county: "Madison", label: "Madison County", url: "https://www.co.madison.il.us/departments/cac/" },
];
