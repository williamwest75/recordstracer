...
export const RI_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "ri_sex_offenders", name: "Sex Offender Registry", agency: "RI DCYF / RISP", description: "Registered sex offenders in Rhode Island", searchUrl: "https://sor.ri.gov/", icon: "AlertTriangle" },
...
export const RI_LICENSE_SOURCES: RecordSource[] = [
  ...
  { id: "ri_bar", name: "Attorney Search", agency: "RI Bar Association", description: "Licensed attorneys in Rhode Island", searchUrl: "https://www.ribar.com/for-the-public/find-a-lawyer/", icon: "Scale" },
];
...
export const RI_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Cranston", label: "City of Cranston", url: "https://www.cranstonri.com/government/assessor/" },
