...
export const PA_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "pa_sex_offenders", name: "Sex Offender Registry (Megan's Law)", agency: "PA State Police", description: "Registered sex offenders in Pennsylvania", searchUrl: "https://www.meganslaw.psp.pa.gov/", icon: "AlertTriangle" },
...
export const PA_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Delaware", label: "Delaware County", url: "https://www.delcopa.gov/departments/tax-assessment" },
