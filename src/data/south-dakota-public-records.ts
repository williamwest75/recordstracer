...
export const SD_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "sd_courts", name: "Court Case Search", agency: "SD UJS", description: "Circuit court case records", searchUrl: "https://ujs.sd.gov/CaseSearch.aspx", icon: "Gavel" },
  { id: "sd_doc", name: "Offender Search", agency: "SD DOC", description: "Current inmates in South Dakota", searchUrl: "https://doc.sd.gov/adult/lookup/", icon: "ShieldAlert" },
...
export const SD_LICENSE_SOURCES: RecordSource[] = [
  { id: "sd_medical", name: "Medical License Verification", agency: "SD Board of Medical & Osteopathic Examiners", description: "Physicians licensed in South Dakota", searchUrl: "https://www.sdbmoe.gov/license-lookup", icon: "Stethoscope" },
  { id: "sd_bar", name: "Attorney Search", agency: "State Bar of SD", description: "Licensed attorneys in South Dakota", searchUrl: "https://www.statebarofsouthdakota.com/page/lawyer-search", icon: "Scale" },
];

export const SD_CAMPAIGN_FINANCE_SOURCES: RecordSource[] = [
  { id: "sd_sos_cf", name: "SD Campaign Finance", agency: "SD Secretary of State", description: "Campaign finance reports", searchUrl: "https://sosenterprise.sd.gov/CampaignFinance/CampaignFinanceSearch.aspx", icon: "Vote" },
];
...
export const SD_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Pennington", label: "Pennington County", url: "https://www.pennco.org/153/Equalization" },
  { county: "Lincoln", label: "Lincoln County", url: "https://www.lincolncountysd.org/119/Equalization" },
  { county: "Brown", label: "Brown County", url: "https://www.brown.sd.us/equalization" },
];
