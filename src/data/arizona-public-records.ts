...
export const AZ_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "az_courts", name: "Court Case Search", agency: "AZ Judicial Branch", description: "Superior court case records", searchUrl: "https://apps.supremecourt.az.gov/publicaccess/", icon: "Gavel" },
  ...
  { id: "az_sex_offenders", name: "Sex Offender Registry", agency: "AZ DPS", description: "Registered sex offenders in Arizona", searchUrl: "https://www.azdps.gov/services/public/sex-offender", icon: "AlertTriangle" },
...
export const AZ_LICENSE_SOURCES: RecordSource[] = [
  { id: "az_medical", name: "Medical License Verification", agency: "AZ Medical Board", description: "Physicians licensed in Arizona", searchUrl: "https://azbomprod.glsuite.us/GLSuiteWeb/Clients/AZBOM/Public/Verification.aspx", icon: "Stethoscope" },
  { id: "az_bar", name: "Attorney Search", agency: "State Bar of Arizona", description: "Licensed attorneys in Arizona", searchUrl: "https://www.azbar.org/find-a-lawyer/", icon: "Scale" },
...
export const AZ_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Yavapai", label: "Yavapai County Assessor", url: "https://www.yavapai.us/assessor" },
