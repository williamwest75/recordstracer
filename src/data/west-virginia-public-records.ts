...
export const WV_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "wv_courts", name: "Court Case Search", agency: "WV Judiciary", description: "Circuit and magistrate court records", searchUrl: "https://www.courtswv.gov/courts/case-information", icon: "Gavel" },
  ...
  { id: "wv_sex_offenders", name: "Sex Offender Registry", agency: "WV State Police", description: "Registered sex offenders in West Virginia", searchUrl: "https://www.wvsp.gov/PublicResources/Pages/SexOffenderRegistrySearch.aspx", icon: "AlertTriangle" },
...
export const WV_LICENSE_SOURCES: RecordSource[] = [
  ...
  { id: "wv_bar", name: "Attorney Search", agency: "WV State Bar", description: "Licensed attorneys in West Virginia", searchUrl: "https://www.wvbar.org/for-the-public/find-an-attorney/", icon: "Scale" },
];
...
export const WV_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Berkeley", label: "Berkeley County Assessor", url: "https://www.berkeleywv.org/government/assessor" },
  { county: "Cabell", label: "Cabell County Assessor", url: "https://cabellassessor.com/" },
  { county: "Monongalia", label: "Monongalia County", url: "https://monongalia.assessor.wvgis.wvu.edu/" },
];
