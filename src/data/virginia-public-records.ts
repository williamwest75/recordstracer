...
export const VA_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "va_doc", name: "Offender Search", agency: "VA DOC", description: "Current inmates in Virginia facilities", searchUrl: "https://vadoc.virginia.gov/offenders/locator/index.htm", icon: "ShieldAlert" },
...
export const VA_LICENSE_SOURCES: RecordSource[] = [
  ...
  { id: "va_bar", name: "Attorney Search", agency: "VA State Bar", description: "Licensed attorneys in Virginia", searchUrl: "https://www.vsb.org/vlrs/", icon: "Scale" },
];
...
export const VA_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Loudoun", label: "Loudoun County", url: "https://icare.loudoun.gov/LoudounCare/search/commonsearch.aspx?mode=OWNER" },
  { county: "Chesterfield", label: "Chesterfield County", url: "https://www.chesterfield.gov/194/Real-Estate-Assessments" },
  { county: "Henrico", label: "Henrico County", url: "https://realestate.henrico.us/" },
  { county: "Arlington", label: "Arlington County", url: "https://propertysearch.arlingtonva.us/" },
