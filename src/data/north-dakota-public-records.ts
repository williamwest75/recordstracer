...
export const ND_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "nd_courts", name: "Court Case Search", agency: "ND Courts", description: "District court case records", searchUrl: "https://www.ndcourts.gov/legal-self-help/court-records", icon: "Gavel" },
  { id: "nd_doc", name: "Offender Search", agency: "ND DOCR", description: "Current inmates and supervised offenders", searchUrl: "https://docr.nd.gov/adult-services/offender-search", icon: "ShieldAlert" },
...
export const ND_LICENSE_SOURCES: RecordSource[] = [
  { id: "nd_medical", name: "Medical License Verification", agency: "ND Board of Medicine", description: "Physicians licensed in North Dakota", searchUrl: "https://www.ndbom.org/public/find_verify/", icon: "Stethoscope" },
...
export const ND_CAMPAIGN_FINANCE_SOURCES: RecordSource[] = [
  { id: "nd_sos_cf", name: "ND Campaign Finance", agency: "ND Secretary of State", description: "Campaign finance disclosures", searchUrl: "https://apps.nd.gov/sc/campaignfinance/", icon: "Vote" },
];
...
export const ND_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Burleigh", label: "Burleigh County", url: "https://www.burleighco.com/government/departments/equalization/" },
  { county: "Grand Forks", label: "Grand Forks County", url: "https://www.gfcounty.nd.gov/departments/tax-equalization" },
  { county: "Ward", label: "Ward County", url: "https://www.wardcountynd.gov/government/tax-equalization" },
];
