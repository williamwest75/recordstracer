...
export const AR_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "ar_doc", name: "Inmate Search", agency: "AR DOC", description: "Current inmates in Arkansas state prisons", searchUrl: "https://apps.adc.arkansas.gov/InmateSearch/", icon: "ShieldAlert" },
  { id: "ar_sex_offenders", name: "Sex Offender Registry", agency: "AR Crime Information Center", description: "Registered sex offenders in Arkansas", searchUrl: "https://sorcity.arstatesheriffs.com/", icon: "AlertTriangle" },
  ...
  { id: "ar_ucc", name: "UCC Filings", agency: "AR Secretary of State", description: "Uniform Commercial Code financing statements", searchUrl: "https://www.sos.arkansas.gov/business-commercial-services-bcs/ucc-filings", icon: "FileText" },
];
...
export const AR_CAMPAIGN_FINANCE_SOURCES: RecordSource[] = [
  { id: "ar_sos_cf", name: "AR Campaign Finance", agency: "AR Secretary of State", description: "Campaign contributions and expenditure reports", searchUrl: "https://financial-disclosures.sos.arkansas.gov/", icon: "Vote" },
];
...
export const AR_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Sebastian", label: "Sebastian County", url: "https://www.sebastiancountyar.gov/assessor" },
];
