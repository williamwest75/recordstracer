...
export const NE_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "ne_doc", name: "Inmate Search", agency: "NE DCS", description: "Current inmates in Nebraska facilities", searchUrl: "https://dcs-inmatesearch.ne.gov/Corrections/InmateSearch.aspx", icon: "ShieldAlert" },
...
export const NE_CAMPAIGN_FINANCE_SOURCES: RecordSource[] = [
  { id: "ne_nadc_cf", name: "NE Campaign Finance", agency: "NE Accountability & Disclosure Commission", description: "Campaign contributions and expenditures", searchUrl: "https://nadc.nebraska.gov/ccdb/search.cgi", icon: "Vote" },
];
...
export const NE_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Lancaster", label: "Lancaster County Assessor", url: "https://www.lancaster.ne.gov/173/Assessor-Register-of-Deeds" },
  { county: "Sarpy", label: "Sarpy County Assessor", url: "https://www.sarpy.gov/155/Assessor" },
  { county: "Hall", label: "Hall County Assessor", url: "https://www.hallcountyne.gov/government/assessor" },
];
