...
export const NJ_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "nj_doc", name: "Inmate Search", agency: "NJ DOC", description: "Current inmates in New Jersey facilities", searchUrl: "https://www20.state.nj.us/DOC_Inmate/inmatesearch", icon: "ShieldAlert" },
  { id: "nj_sex_offenders", name: "Sex Offender Registry", agency: "NJ State Police", description: "Registered sex offenders in New Jersey", searchUrl: "https://www.nj.gov/njsp/sex-offender-registry/", icon: "AlertTriangle" },
...
export const NJ_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Essex", label: "Essex County", url: "https://www.essexcountynj.org/departments/board-of-taxation" },
  ...
  { county: "Camden", label: "Camden County", url: "https://www.camdencounty.com/government/offices/board-of-taxation/" },
