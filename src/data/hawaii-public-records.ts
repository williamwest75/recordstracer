...
export const HI_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "hi_courts", name: "Court Case Search (eCourt Kokua)", agency: "HI Judiciary", description: "Civil, criminal, and family court records", searchUrl: "https://www.courts.state.hi.us/go/jims", icon: "Gavel" },
...
export const HI_LICENSE_SOURCES: RecordSource[] = [
  ...
  { id: "hi_bar", name: "Attorney Search", agency: "HI Supreme Court", description: "Licensed attorneys in Hawaii", searchUrl: "https://hsba.org/HSBA/HSBA/For-the-Public/Member-Search.aspx", icon: "Scale" },
];
