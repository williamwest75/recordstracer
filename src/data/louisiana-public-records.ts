...
export const LA_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "la_courts", name: "Court Case Search", agency: "LA Supreme Court", description: "District court case records", searchUrl: "https://www.lasc.org/About_the_Court/courts_in_louisiana.asp", icon: "Gavel" },
  { id: "la_doc", name: "Offender Search", agency: "LA DOC", description: "Current inmates in Louisiana facilities", searchUrl: "https://doc.louisiana.gov/imprisoned-person-locator/", icon: "ShieldAlert" },
...
export const LA_LICENSE_SOURCES: RecordSource[] = [
  { id: "la_lsbme", name: "Medical License Verification", agency: "LA State Board of Medical Examiners", description: "Physicians licensed in Louisiana", searchUrl: "https://www.lsbme.la.gov/licensure/verification", icon: "Stethoscope" },
  { id: "la_bar", name: "Attorney Search", agency: "LA State Bar Association", description: "Licensed attorneys in Louisiana", searchUrl: "https://www.lsba.org/Public/FindALawyer.aspx", icon: "Scale" },
];

export const LA_CAMPAIGN_FINANCE_SOURCES: RecordSource[] = [
  { id: "la_ethics_cf", name: "LA Campaign Finance", agency: "LA Ethics Administration", description: "Campaign contributions and expenditures", searchUrl: "https://ethics.la.gov/CampaignFinanceSearch/SearchEfilingContributions.aspx", icon: "Vote" },
];
