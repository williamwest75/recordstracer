...
export const WY_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "wy_courts", name: "Court Case Search", agency: "WY Judiciary", description: "District court case records", searchUrl: "https://www.courts.state.wy.us/court-records/", icon: "Gavel" },
  { id: "wy_doc", name: "Offender Search", agency: "WY DOC", description: "Current inmates in Wyoming facilities", searchUrl: "https://corrections.wyo.gov/inmates-and-டoners/inmate-search", icon: "ShieldAlert" },
  { id: "wy_sex_offenders", name: "Sex Offender Registry", agency: "WY DCI", description: "Registered sex offenders in Wyoming", searchUrl: "https://sor.wyo.gov/", icon: "AlertTriangle" },
  { id: "wy_voter", name: "Voter Registration", agency: "WY Secretary of State", description: "Voter registration status", searchUrl: "https://sos.wyo.gov/Elections/Docs/WYVoterRegistration.aspx", icon: "Vote" },
...
export const WY_LICENSE_SOURCES: RecordSource[] = [
  { id: "wy_medical", name: "Medical License Verification", agency: "WY Board of Medicine", description: "Physicians licensed in Wyoming", searchUrl: "https://wyomedboard.wyo.gov/verify-a-license", icon: "Stethoscope" },
  { id: "wy_bar", name: "Attorney Search", agency: "WY State Bar", description: "Licensed attorneys in Wyoming", searchUrl: "https://www.wyomingbar.org/for-the-public/find-a-lawyer/", icon: "Scale" },
];
...
export const WY_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Natrona", label: "Natrona County Assessor", url: "https://www.natronacounty-wy.gov/185/Assessor" },
