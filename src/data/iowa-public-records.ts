...
export const IA_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "ia_courts", name: "Court Case Search", agency: "IA Judicial Branch", description: "Civil, criminal, and family court records", searchUrl: "https://www.iowacourts.gov/for-the-public/court-case-information/", icon: "Gavel" },
  { id: "ia_doc", name: "Offender Search", agency: "IA DOC", description: "Current inmates in Iowa state prisons", searchUrl: "https://letterfinder.doc.iowa.gov/", icon: "ShieldAlert" },
...
export const IA_LICENSE_SOURCES: RecordSource[] = [
  ...
  { id: "ia_bar", name: "Attorney Search", agency: "IA Judicial Branch", description: "Licensed attorneys in Iowa", searchUrl: "https://www.iacourtcommissions.org/OPR_Public/Attorney/AttySearch.aspx", icon: "Scale" },
];
...
export const IA_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Johnson", label: "Johnson County Assessor", url: "https://www.johnson-county.com/assessor/" },
  { county: "Black Hawk", label: "Black Hawk County", url: "https://www.bhcgov.com/assessor/" },
];
