...
export const MN_STATEWIDE_SOURCES: RecordSource[] = [
  ...
  { id: "mn_sex_offenders", name: "Sex Offender Registry", agency: "MN BCA", description: "Registered sex offenders in Minnesota", searchUrl: "https://coms.doc.state.mn.us/Level3SexOffenders", icon: "AlertTriangle" },
...
export const MN_LICENSE_SOURCES: RecordSource[] = [
  { id: "mn_health", name: "Medical License Verification", agency: "MN Board of Medical Practice", description: "Physicians licensed in Minnesota", searchUrl: "https://mn.gov/boards/medical-practice/find-a-doctor/", icon: "Stethoscope" },
...
export const MN_PROPERTY_SOURCES: CountyPropertySource[] = [
  ...
  { county: "Ramsey", label: "Ramsey County", url: "https://www.ramseycounty.us/residents/property-home/property-search" },
  { county: "Dakota", label: "Dakota County", url: "https://www.co.dakota.mn.us/HomeProperty/PropertyInformation/Pages/default.aspx" },
  { county: "Anoka", label: "Anoka County", url: "https://www.anokacounty.us/399/Property-Information" },
